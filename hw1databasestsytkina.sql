...
with number_of_rides_per_person_where_more_than_ten (number_of_rides_of_a_user) as (
select number_of_rides_of_a_user 
from rides_union 
where number_of_rides_of_a_user >10
)
SELECT *
FROM number_of_rides_per_person_where_more_than_ten;
